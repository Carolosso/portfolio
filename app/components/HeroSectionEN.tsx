				...
				<motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-8 md:mb-12">
					<div className="space-y-3 md:space-y-4 mb-6 md:mb-8">
						...
						<p className="text-lg md:text-xl text-gray-400 max-w-2xl mx-auto">
							Creating practical solutions tailored to clients needs, combining a passion for programming with knowledge of electronics and telecommunications.
						</p>
						<p className="text-base md:text-lg text-gray-500 max-w-2xl mx-auto">
							I earned a Master of Science in Engineering at <span className="text-blue-400">Rzeszów University of Technology</span> in the field of {' '}
							<span className="text-purple-400">Electronics and Telecommunications</span>
						</p>
					</div>
					...
					>
						<div className="grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-8">
							...
							<div
								...
								onMouseLeave={() => setSelectedStack(null)}
							>
								<h3 className="text-lg md:text-xl font-semibold mb-3 md:mb-4 text-blue-400">IT Support </h3>
								<ul className="space-y-1.5 md:space-y-2 text-xs md:text-sm text-gray-400">
									<li className="flex items-center gap-2">
