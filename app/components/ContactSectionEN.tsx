			...
			<div className="max-w-4xl mx-auto text-center">
				<motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="space-y-8">
					{/* <p className="text-lg md:text-xl text-gray-400 max-w-2xl mx-auto">
						Szukasz programisty full-stack, który potrafi zaprojektować i wdrożyć kompleksowe rozwiązania? Porozmawiajmy o Twoim projekcie.
					</p> */}
					...
					<div className="flex items-center justify-center gap-2 text-gray-400">
						...
						<span>Rzeszow, PL</span>
					</div>

					{/* Contact Buttons */}
					<div className="flex flex-col sm:flex-row justify-center gap-4">
						<a
							href="mailto:carolosso@outlook.com"
					...
					<div className="flex justify-center gap-6">
						<a
							href="https://github.com/Carolosso"
							target="_blank"
						...
						<a
							href="https://linkedin.com/in/karol-bulanowski"
							target="_blank"
							rel="noopener noreferrer"
							className="text-gray-400 hover:text-white transition-colors p-2 hover:bg-gray-800 rounded-lg"
						>
